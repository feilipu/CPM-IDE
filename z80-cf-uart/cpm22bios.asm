...
; March 2018
;
; Adapted to Compact Flash Module & UART - March 2025
;
...
;   Set up Page 0
    ...
    ld      ($0038),a               ;jmp _uart_interrupt
    ld      hl,_uart_interrupt
    ld      ($0039),hl              ;enable uart interrupt at rst 38
...
;*    RAM PHASE. Mini-FAT is common/fatfs.asm        *
